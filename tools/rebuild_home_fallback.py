...
def main():
    ...
    starter = ['mem-u-zin', 'story-mame-alan', 'zembilfiros', 'neo-aramaic-kurdish-folklore-2022-v2', 'diwana-melaye-ciziri', 'story-siyabend-u-xece', 'diwani-mahwi', 'story-17']
    def rank(b):
...
<a class="cover tone-{e(b['tone'])} {long_class}" href="{e(url)}"><span class="cover-language">{language}{' · PDF' if b['format']=='pdf' else ''}</span><h3 class="cover-title" dir="auto">{e(b['title'])}</h3><img class="cover-ornament" src="assets/motifs/{motif}.svg" alt="" loading="lazy">{note_html}</a>
<div class="card-body"><p class="book-author" dir="auto">{e(author)}</p><div class="card-actions"><a class="shelf-read" href="{e(url)}">{label} →</a>{info}</div></div></article>''')
    p = ROOT / 'index.html'
    text = p.read_text()
